...
class PlacesAutocompleteResult extends StatefulWidget {
  ...
  const PlacesAutocompleteResult({this.onTap, this.logo});
...
class AppBarPlacesAutoCompleteTextField extends StatefulWidget {
  ...
  const AppBarPlacesAutoCompleteTextField({Key? key, this.textDecoration, this.textStyle}) : super(key: key);
...
class PredictionsListView extends StatelessWidget {
  ...
  const PredictionsListView({required this.predictions, this.onTap});
