...
class _YourNotificationScreenState extends State<NotificationScreen> {
  static Stream<QuerySnapshot> _getAcceptedProduct() {
    final FirebaseAuth _firebaseAuth = FirebaseAuth.instance;
    User? user = _firebaseAuth.currentUser;
    String userdoc = user!.uid;
    final CollectionReference _mainCollection = FirebaseFirestore.instance.collection('Volunt_Users').doc(userdoc).collection("DONATEDPRODUCTS");
