...
class RegistrationFoodie extends StatefulWidget {
  const RegistrationFoodie({Key? key}) : super(key: key);

  @override
  _RegistrationFoodieState createState() => _RegistrationFoodieState();
}

class _RegistrationFoodieState extends State<RegistrationFoodie> {
